...
namespace SearchingGram.Controllers
{
    ...
    public class ValuesController : Controller
    {
        ...
        public ValuesController(DataDbContext db, WatcherDbContext wdb,IInstaService instaService, ITwitterService twitterService, ITikTokService tikTokService, ITimerService timer, IYou_TubeService youtubeService)
        {
            _Db = db;
            _WDb = wdb;
