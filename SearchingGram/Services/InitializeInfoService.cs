...
{
    public class InitializeInfoService : IInitializeInfoService
    {
        ...
        public InitializeInfoService(WatcherDbContext wdb, IInstaService instaService, ITwitterService twitterService, ITikTokService tikTokService, ITimerService timer, IYou_TubeService you_TubeService)
        {
            _WDb = wdb;
        ...
        public async Task InitInfoInsta(string name)
        {
        ...
        public async Task InitInfoTwitter(string name)
        {
        ...
        public async Task InitInfoYouTube(string name)
        {
